...
import top.wangchenyan.android.common.ext.toUnMutable
import top.wangchenyan.android.common.utils.filedownloader.FileDownloader
...
object CommonApp {
    ...
    fun init(block: CommonConfig.Builder.() -> Unit) {
        ...
        GsonUtils.setGsonDelegate(top.wangchenyan.android.common.utils.GsonUtils.gson)
